...
- [x] **Step 1: Inspect and fix container layout in `TerminalView.tsx`**
...
- [x] **Step 2: Debounce and synchronize PTY resize on initial mount in `useTerminalSession.ts`**
...
- [x] **Step 3: Test terminal height calculation**
...
- [x] **Step 1: Add custom key event handler in `useTerminalSession.ts`**
...
- [x] **Step 2: Suppress unintended middle click and handle context menu in `TerminalView.tsx`**
...
- [x] **Step 3: Test copy, paste, and right click in terminal**
...
- [x] **Step 1: Write unit test for semver equality and cache invalidation**
...
- [x] **Step 2: Fix semver logic in `src/services/updateChecker.ts`**
...
- [x] **Step 3: Update `StatusBar.tsx` with manual check feedback**
...
- [x] **Step 1: Add history stacks to `fileManagerStore.ts`**
...
- [x] **Step 2: Hook mouse buttons and shortcuts in `FilePane.tsx`**
...
- [x] **Step 3: Test pane history navigation**
...
- [x] **Step 1: Update `PathBreadcrumb.tsx` to display direct raw path input by default**
...
- [x] **Step 2: Test raw path navigation**
...
- [x] **Step 1: Always show bookmark toolbar in `DualPaneExplorer.tsx`**
...
- [x] **Step 2: Add "Add to Bookmarks" in folder context menu (`ContextMenu.tsx`)**

When right-clicking a folder entry, add "Add to Bookmarks" option.

- [x] **Step 3: Test bookmark creation and recall**
...
- [x] **Step 1: Create `DirectoryTree.tsx`**
...
- [x] **Step 2: Add directory tree state to `fileManagerStore.ts`**
...
- [x] **Step 1: Integrate `DirectoryTree` into Local and Remote panes**
...
- [x] **Step 2: Move `TransferDrawer` inside `DualPaneExplorer`**
...
- [x] **Step 3: Test multi-axis resizing**
...
- [x] **Step 1: Create `src/stores/themeStore.ts`**
